<template>
    <div class="w-full h-[96px] flex justify-center">
        <div class="w-[1280px] h-[96px] min-w-0 mx-10 md:mx-4">
            <div class="flex flex-col space-y-4 justify-center w-full items-start md:items-center">
                <h1 class="text-white font-bold text-xl md:text-5xl">Champions of the Arena</h1>
                <h2 class="text-white text-base md:text-xl font-light">Meet the elite players dominating the game</h2>
            </div>
        </div>
    </div>
    <div class="w-full h-full flex justify-center mt-4 md:mt-14">
